import styles from '../../assets/GameSection.module.css'
...
export const GameSection = () => {
  ...
  const [isPaused, changeIsPaused, currentTime] = allAppStates(state => [state.isPaused, state.changeIsPaused, state.currentTime]);
  ...
  const toggleActiveStyles = (elements, index) => {
    ...
    const verticalLinesNumbers = [2, 5, 11, 14, 29, 32, 38, 41, 56, 59, 65, 68, 74, 77]
    const horizontalLinesNumbers = [18, 19, 21, 22, 24, 25, 26, 45, 45, 46, 48, 49, 51, 52, 53]
